...
const initialState: ChatTypes = {
  ...
  lists: [
    ...
    },
    {
      ...
      message: {
        img: [
          ...
          { uri: "https://lain.bgm.tv/pic/cover/l/43/d9/14588_bDB2r.jpg", hash: "", width: 200, height: 10, size: 1024 }
        ]
      },
      date: 1559377920312,
      type: "img"
    },
    {
      ...
      message: {
        text: "因为是个好孩子所以被赐予主人公的宝座，但是存在感却因其他角色而渐渐被淡化中，因此没有多少主角的感觉。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "暴走状态时周围的人完全无法阻止，没人能够跟上她的步调也没问题。实质是从事同人活动的宅女。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "负责对京子的吐槽。作为一人独居的少女，有很黑暗、很深的…其实基本没有。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "与人气动画《小魔女米拉库》的主人公相似，是会装可爱的女孩子。"
      },
      date: 1559377920312,
      type: "text"
    },
    ...
    },
    {
      ...
      message: {
        text: "池田千岁的双胞胎妹妹，讨厌京子，喜欢幻想姐姐×绫乃。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "以下届学生会副会长为目标的傲娇少女。与向日葵组成傲娇×傲娇的一对CP！？"
      },
      date: 1559377920312,
      type: "text"
    },
    ...
    },
    {
      ...
      message: {
        text: "通过过激的百合妄想，而使被忘掉的百合度急剧上升的好人。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "灯里的姐姐，19岁的大学生，同灯里一样的发色，不过留长发，长发后还有扎有一小撮短发，绑有一个团子。常以笑脸示人。与千夏的姐姐吉川智子相识。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "理科教师，喜欢做奇怪的实验，经常引起爆炸。唯一能解读松本的人。"
      },
      date: 1559377920312,
      type: "text"
    },
    ...
    },
    {
      ...
      message: {
        text: "向日葵的妹妹，6岁，同向日葵几乎一样的外貌，不过眉毛较粗，10月30日出生。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "结衣亲戚的小孩，喜欢吃海胆寿司。个性沉默而且成熟，也有小孩天真的一面，崇敬结衣。喜欢看《小魔女米拉库》"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "櫻子と花子の姉。18歳。1月21日生まれ。 櫻子に比べて冷めた性格であり、櫻子のことを厄介に思っている面がある。櫻子より髪が短い。"
      },
      date: 1559377920312,
      type: "text"
    },
    {
      ...
      message: {
        text: "櫻子と撫子の妹。8歳。8月7日生まれ。 櫻子のことを呼び捨てにしている。しっかり者で、学校のクラスメイト達からは「花子様」と呼ばれている。"
      },
      date: 1559377920312,
      type: "text"
    }
